...
let
//A function to get a value from an arbitrary path of 6 fields
...
let
//"propertySets","properties","nominalValue","value"
...
//Welcome
		...
		(
			...
			[
				Headers = 
				[
					#"Authorization"="Bearer " & "wa2gqfZy7tRkozEh441t2w",
		...
		ifcElements = Json.Document(GetText3 ),

//Create the table
initialTable = Table.FromList(ifcElements, Splitter.SplitByNothing(), null, null, ExtraValues.Error),
...
attributesNames = GetAll1FieldNames(ifcElements,"attributes"),
...
propertyPaths = UniquePathListFromRecords(ifcElements,"propertySets","properties","nominalValue","value"),

//Get all quantities paths
quantityPaths = UniquePathListFromRecords(ifcElements,"quantitySets","quantities","value","value"),
